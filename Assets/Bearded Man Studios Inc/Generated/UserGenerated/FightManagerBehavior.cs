...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class FightManagerBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (FightManagerNetworkObject)obj;
		...
		{
			Initialize(new FightManagerNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new FightManagerNetworkObject(networker, this, createCode, metadata);
		}
