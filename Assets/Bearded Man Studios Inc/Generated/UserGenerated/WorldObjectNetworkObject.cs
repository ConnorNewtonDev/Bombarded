...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class WorldObjectNetworkObject : NetworkObject
	{
		...
		public WorldObjectNetworkObject() : base() { Initialize(); }
		public WorldObjectNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public WorldObjectNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
